...
class ApgEdr_Logo3D_Breda_2024 extends ApgEdr_Logo3D {
    ...
    constructor(awindow, adocument) {
        ...
        this.gltfUrl = "/assets/gltf/ApgEdr_Logo3D_Breda_2024_V01.glb"
...
new ApgEdr_Logo3D_Breda_2024(window, document).Init().Loop();
