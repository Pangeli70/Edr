...
export class ApgCdn_Logo3D {
    ...
    #CANVAS_ELEMENT_ID = "ApgCdn_3DLogo_Placeholder_Div";
    
    // This div ID must be inside the Html
    #HOST_ELEMENT_ID = "ApgCdn_3DLogo_AssetsHost_Hidden";
    ...
    InitGltf() {
        ...
        loader.load(gltfUrl, (gltf) => {
            ...
            this.isLoaded = true;
            console.log('ApgCdn_Logo3D.js Ver.' + this.Version + ': GLTF logo is loaded');
        });
    }
