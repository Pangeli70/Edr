...
export class ApgEdr_HtmlPageResource_About
    extends Edr.ApgEdr_HtmlPageResource_Message {

    override readonly RESOURCE_NAME = ApgEdr_HtmlPageResource_About.name;
