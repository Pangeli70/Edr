...
export class ApgEdr_ReservedHtmlPageResource_Environment extends Edr.Drash.Resource {
    ...
    #getSelectComponent_environment() {
        ...
        const apgSelected = Edr.ApgEdr_Service.DefaultFavicon == "ApgCdn_Favicon_Apg_2024_V01" ? "selected" : "";
        r.push(`<option value="Apg" ${apgSelected}>Apg</option>`);
        
        const bredaSelected = Edr.ApgEdr_Service.DefaultFavicon == "ApgCdn_Favicon_Breda_2024_V01" ? "selected" : "";
    ...
    async POST(
        ...
        switch (rawEnv) {
            case "Breda":
                ...
                break
            default: // case "Apg":
                Edr.ApgEdr_Service.DefaultFavicon = "ApgCdn_Favicon_Apg_2024_V01";
                Edr.ApgEdr_Service.DefaultLogoJs = "ApgCdn_Logo3D_Apg_2024_V01";
                break;
        }
