...
export class ApgEdr_ReservedHtmlPageResource_Tng_Chunk extends Edr.Drash.Resource {

    readonly EDR_ROLE = Edr.ApgEdr_Auth_eRole.ADMIN;
    readonly PATH_PARAM_ID = 'id'

    override paths = [Edr.ApgEdr_Route_eShared.RESERVED_PAGE_TNG_CHUNK + "/:" + this.PATH_PARAM_ID];
    ...
    async GET(
        ...
        (<any>data).backLink = Edr.ApgEdr_Route_eShared.RESERVED_PAGE_TNG_CACHES + "#Chunk_" + data.id;
