...
export class ApgEdr_Auth_TngResource_Log_Entry

    extends ApgEdr_Auth_TngResource {


    override readonly RESOURCE_NAME = ApgEdr_Auth_TngResource_Log_Entry.name;
    ...
    #handleIdNotFoundError(
        ...
        ApgEdr_Service.HandleError(
            aedr,
            ApgEdr_Auth_TngResource_Log_Entry.name,
            this.GET.name,
        );
