...
export class ApgEdr_Dev_TngResource_Tng_Function
    ...
    override paths = [ApgEdr_Route_eShared.DEV_PAGE_TNG_FUNCTION + "/:" + this.PATH_PARAM_ID];
    ...
    async GET(
        ...
        (<any>data).backLink = ApgEdr_Route_eShared.DEV_PAGE_TNG_CACHES + "#Function_" + data.id;
